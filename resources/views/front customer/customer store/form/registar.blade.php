...
<body class="body1">
    ...
    <!--end header-->
    <div class="container">
        <form class="row g-3" id="form1" method="POST" action="/client/{{$store->id}}/client/registar">
            @csrf
            ...
            <div class="creat">
                @include('shared.error')
                    ...
                    <input name="fullname" type="text" class="form-control" id="fullname"  aria-describedby="emailHelp" value="{{ old('fullname') }}" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="phone" type="number" class="form-control" id="phone" required value="{{old('phone')}}">
                        </div>

                        <div class="form-group">
                            <input name="role" type="text" class="form-control" id="role" value="buyer" hidden>
                        </div>
