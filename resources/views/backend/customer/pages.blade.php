...
<a href="/pages/create" class="btn btn-primary" id="creat" >creat pages</a>

<h4> Welcome <strong>{{auth()->user()->first_name}}</strong> here you will find all the pages of your stores</h4>
...
<table class="table">
    ...
    <tbody>
      ...
      <tr>
        @foreach (auth()->user()->pages as $item)
        ...
        <td class="text-right footable-last-visible" style="display: table-cell;">
            ...
            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="/pages/edite/{{$item->id}}" title="edite">
            ...
            <a href="/pages/delete/{{$item->id}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="#" title="delete">
