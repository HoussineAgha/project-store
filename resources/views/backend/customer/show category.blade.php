...
@section('title','All Category for this store')
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right footable-last-visible" style="display: table-cell;">
            ...
            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('edit.category',$item->id)}}" target="_blank" title="edite">
            ...
            <a href="{{route('delete.category',$item->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="#" title="delete">
