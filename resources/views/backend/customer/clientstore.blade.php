...
@section('title','Client - '.$store->name_store)
...
<a href="#" class="btn btn-primary" id="creat" >Add Client</a>

<h4> The Clients spicial in this store:<strong> {{$store->name_store}} </strong></h4>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right footable-last-visible" style="display: table-cell;">
            ...
            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('edit.client',$item->id)}}" title="edite">
            ...
            <a href="{{route('delete.client',$item->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="#" title="delete">
      ...
      <div class="alert alert-warning" role="alert" style="margin-top: 25px; text-align:center;">
        <h5>There are currently no clients in this store</h5>
      </div>
