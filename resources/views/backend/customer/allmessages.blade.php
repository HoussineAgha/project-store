...
@section('content2')
<div class="messages">
    <h4>Note : These are your <span style="color: red">private</span> messages from admin</h4>
</div>
<table class="table">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right footable-last-visible" style="display: table-cell;">
            <a class="btn btn-soft-success btn-icon btn-circle btn-sm" href="{{route('user.detailsmessages',$item->id)}}" target="_blank" title="view">
