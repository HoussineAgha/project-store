...
<form method="POST" action="/pages/store" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-md-12">
                ...
                <input name="title" type="text" class="form-control" id="title" placeholder="Name page">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <img id="blah" src="{{ asset('img/defult.jpg') }}" alt="your image" width="100%px" height="300px" />
                </div>
